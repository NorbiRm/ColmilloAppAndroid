        ...
        fun newInstance(curso: CursoCard) =
            Camera().apply {
                arguments = Bundle().apply {
                    putSerializable(CURSO_PARAM, curso as CursoCard)
                }
            }
    }
        ...
        if (imageFoto!=null){
            ...
            uploadTask.addOnFailureListener {
                ...
                storageRef.getDownloadUrl().addOnSuccessListener(OnSuccessListener() {
                    ...
                    var cursoRef = database!!.getReference("cursos").child(curso!!.id).child("fotos")
                    var idFoto = foto.idFoto;
                    Log.i("CameraCurso",cursoRef.toString())
                    cursoRef.push().setValue(idFoto)
